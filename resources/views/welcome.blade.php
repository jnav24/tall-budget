                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                    <a href="https://tailwindcss.com/docs" target="_blank"
                        ...
                        <div>
                            <div
                                ...
                                <svg class="text-indigo-400 fill-current w-7 h-7" viewBox="0 0 50 31"
                            ...
                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                Tailwind CSS is a popular utility-first CSS framework that makes it easy
                                to style pages by applying pre-defined classes to HTML elements.
                            </p>
                        </div>
                    ...
                    <a href="https://alpinejs.dev/docs" target="_blank"
                        ...
                        <div>
                            <div
                                class="flex items-center justify-center w-16 h-16 rounded-full bg-indigo-50 dark:bg-indigo-900/20">
                                <svg class="text-indigo-400 fill-current w-7 h-7" viewBox="0 0 55 25"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                AlpineJS is a lightweight JavaScript framework that allows you to add
                                interactivity to your HTML using simple declarative syntax.
                            </p>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5"
                    ...
                    <a href="https://laravel.com/docs" target="_blank"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                Laravel is a free and open-source PHP web framework that allows
                    ...
                    <a href="https://livewire.laravel.com/docs"
                        ...
                        <div>
                            <div
                                ...
                                <svg class="text-indigo-400 translate-x-px translate-y-px fill-current w-7 h-7"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="currentColor" />
                                    <mask id="a-livewire" style="mask-type:alpha"
                                        maskUnits="userSpaceOnUse" x="6" y="23" width="27"
                                        height="22">
                                        <path
                                    ...
                                    <mask id="b-livewire" style="mask-type:alpha"
                                        maskUnits="userSpaceOnUse" x="6" y="19" width="27"
                                        height="14">
                                        <path
                            ...
                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                                Livewire is a tool that simplifies the process of creating interactive
                                and dynamic user interfaces using PHP and Laravel.
                            </p>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5"
